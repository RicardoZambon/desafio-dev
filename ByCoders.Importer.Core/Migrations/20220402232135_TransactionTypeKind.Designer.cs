...
namespace ByCoders.Importer.Core.Migrations
{
    ...
    [Migration("20220402232135_TransactionTypeKind")]
    partial class TransactionTypeKind
    {
            ...
            modelBuilder.Entity("ByCoders.Importer.Core.BusinessEntities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Ricardo Zambon",
                            PasswordHash = "nvqe6Ku4Te4EwukbPWq3VSVeAIKD5E88cZ8QVUMCGseQi5LBIZNqNPUWQuir6QQF",
